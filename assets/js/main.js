(function ($) {
    ...
    jQuery(document).ready(function () {
        ...
        // category activation
        const openCat = document.querySelector('._open-cat');
        ...
        const srcbar = document.querySelector('.full-width-search');
        const _open = document.querySelector('.open_');

        _close.addEventListener('click', function () {

            srcbar.style.visibility = 'hidden';
            srcbar.style.opacity = '0';
        });

        _open.addEventListener('click', function () {
            srcbar.style.visibility = 'visible';
            srcbar.style.opacity = '1';
